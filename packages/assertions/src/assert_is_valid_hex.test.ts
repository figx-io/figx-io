...
describe('assert_is_valid_hex', () => {
	...
	it('when assert_is_valid_hex("#12") it should throw a TypeError', () => {
		expect(() => {
			assert_is_valid_hex('#12');
		}).toThrow(TypeError);
	});
	it('when assert_is_valid_hex("#123") it should throw a TypeError', () => {
		expect(() => {
			assert_is_valid_hex('#123');
		}).toThrow(TypeError);
	});
	it('when assert_is_valid_hex("#1234") it should throw a TypeError', () => {
		expect(() => {
			assert_is_valid_hex('#1234');
		}).toThrow(TypeError);
	});
	it('when assert_is_valid_hex("#12345") it should throw a TypeError', () => {
		expect(() => {
			assert_is_valid_hex('#12345');
		}).toThrow(TypeError);
	});
	it('when assert_is_valid_hex("#1234567") it should throw a TypeError', () => {
		expect(() => {
			assert_is_valid_hex('#1234567');
		}).toThrow(TypeError);
	});
	it('when assert_is_valid_hex(1) it should throw a TypeError', () => {
		expect(() => {
