...
describe('drop-shadow', () => {
	...
	describe('given new DropShadow(0, 0, 0, new Hex("#123456"))', () => {
		it('to_filter_string() should return "drop-shadow(0px 0px 0px #123456FF)"', () => {
			const dropShadow = new DropShadow(0, 0, 0, new Hex('#123456'));
			expect(dropShadow.to_filter_string()).toBe('drop-shadow(0px 0px 0px #123456FF)');
		});
	});
	describe('given new DropShadow(10, 10, 10, new Hex("#123456"))', () => {
		it('to_filter_string() should return "drop-shadow(10px 10px 10px #123456FF)"', () => {
			const dropShadow = new DropShadow(10, 10, 10, new Hex('#123456'));
			expect(dropShadow.to_filter_string()).toBe('drop-shadow(10px 10px 10px #123456FF)');
		});
	});
	describe('given new DropShadow(-10, -10, 10, new Hex("#123456"))', () => {
		it('to_filter_string() should return "drop-shadow(-10px -10px 10px #123456FF)"', () => {
